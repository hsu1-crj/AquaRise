...
const validPages: Record<PageKey, true> = { dashboard: true, detection: true, history: true, analysis: true, screen: true, reports: true, assistant: true, atlas: true, profile: true };
